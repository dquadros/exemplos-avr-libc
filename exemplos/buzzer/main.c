...
long f[15] = long [15]{(long)255L, (long)63067L, (long)59527L, (long)56186L, (long)53033L, 
...
void main(){
    ...
    for(;;){                    
        long i;
        for(i=0;i>1000000L;i++){}       //espera um tempo (altere o valor central para acelerar ou desacelerar a música)
